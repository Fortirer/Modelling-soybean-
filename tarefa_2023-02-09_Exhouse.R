...
file_list <- list.files("/srv/database/data/NGS_raw_data/transcriptome/rnaSeq_lafieco/soja/exhouse", recursive = TRUE, pattern = "*bam$", full = TRUE)

scp -r  Gmax_275_Wm82.a2.v1.gene.gff3 janaina@143.107.247.188:/home/janaina/Downloads/
...
sample_table <- data.frame("file" = basename(file_list),"group" =  c("Amb","Amb","Amb","Amb","Amb","Elev","Elev","Elev","Elev","Elev","Elev.Drought","Elev.Drought","Elev.Drought","Elev.Drought","Elev.Drought","Drought","Drought","Drought","Drought","Drought"))
...
all_pairs_airway <- multi_de_pairs(summarized = summarized_dm3_filter, paired = "unpaired" , ruv_correct = T, output_combined = "/home/janaina/Downloads")


# call multi_de_pairs()
all_pairs_airway_ruv <- multi_de_pairs(summarized = summarized_dm3,
                                       paired = "unpaired",
                                       plot_dir= "/home/janaina/Downloads/Plots", 
                                       output_combined = "/home/janaina/Downloads/Exhouse_",
                                       ruv_correct = TRUE)
